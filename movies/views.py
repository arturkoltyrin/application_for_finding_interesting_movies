...
from movies.forms import GenreForm, ActorForm, MovieForm
...
class MovieDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        interaction = Interaction.objects.filter(user=self.request.user, movie=movie).first()
    ...
    def post(self, request, *args, **kwargs):
        movie = self.get_object()
        interaction, created = Interaction.objects.get_or_create(user=request.user, movie=movie)
