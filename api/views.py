...
from api.paginators import (ActorPaginator, GenrePaginator,
                            InteractionPaginator, MoviePaginator,
                            UserPaginator)
from api.permissions import (IsAdminUser, IsHimself, IsOwnerOrStaff,
                             IsStaffOrReadOnly)
from api.serializers import (ActorSerializer,
                             CollaborativeRecommendationSerializer,
                             GenreSerializer, InteractionSerializer,
                             MovieSerializer, PageRankRecommendationSerializer,
                             UserRegistrationSerializer, UserSerializer,
                             UserUpdateSerializer)
from interactions.models import Interaction
from movies.models import Actor, Genre, Movie
from recommendations.services import (
    get_collaborative_recommendations_service, get_knn_recommendations_service,
...
def get_statistics_api(request):
    ...
    # Serializing data
    top_rated_movies_data = MovieSerializer(
        statistics_data["top_rated_movies"], many=True
    ).data
    top_active_users_data = UserSerializer(
