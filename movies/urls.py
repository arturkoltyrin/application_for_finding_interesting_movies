...
from movies.views import (ActorCreateView, ActorDeleteView, ActorDetailView,
                          ActorListView, ActorUpdateView, GenreCreateView,
                          GenreDeleteView, GenreDetailView, GenreListView,
                          GenreUpdateView, HomeView, MovieCreateView,
                          MovieDeleteView, MovieDetailView, MovieListView,
                          MovieUpdateView, RecommendationView, StatisticsView)
